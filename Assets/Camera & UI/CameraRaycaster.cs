...
public class CameraRaycaster : MonoBehaviour
{
    ...
    public event OnCursorLayerChange onCursorLayerChangeObservers; // instantiate an observer set

	public delegate void OnClickPriorityLayer(RaycastHit raycastHit, int layerHit); // declare new delegate type
	public event OnClickPriorityLayer onMouseClickObservers; // instantiate an observer set

    public int layer
    {
        get
        {
            return topPriorityLayerLastFrame;
        }
    }
    ...
    void Update()
	{
		...
		{
			onMouseClickObservers (priorityHit.Value, layerHit);
		}
	}
	...
	void NotifyObserersIfLayerChanged(int newLayer)
	{
		if (newLayer != topPriorityLayerLastFrame)
		{
			...
			onCursorLayerChangeObservers (newLayer);
		}
	}
